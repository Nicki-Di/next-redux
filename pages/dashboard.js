    ...
    return (
        <>
            <div>
                ...
                <div className = "hidden md:flex md:flex-col md:fixed md:inset-y-0 w-[15%] shadow-md z-10">
                    {/* Sidebar */}
                    <div className = "flex flex-col flex-grow pt-5 overflow-y-auto bg-s-100 ">
                ...
                {/*header + main*/}
                <div className = "md:w-[85%] flex flex-col flex-1 mr-auto">
                    ...
                    <main className = "flex-1 bg-s-90 min-h-screen">
                        <div className = "py-6">
